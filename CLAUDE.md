...
3. **Verifikasi file management** — pastikan cuma 4 `.md` di project root: `PROMPT_CLAUDE_CODE.md`, `CLAUDE.md` (file ini), `HANDOFF.md`, `README.md`. Kalau ada `CLAUDE_NEXT_PHASES.md` atau `COMMERCIAL_ROADMAP.md`, mereka stale dari konsolidasi sebelumnya — surface to user dengan cleanup command dari §12.3 master prompt.
